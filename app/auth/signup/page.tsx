...
export default function SignupPage() {
  ...
  const { state, signUpWithPassword, signInWithGoogle } = useAuth();
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      const msg = e2 instanceof Error ? e2.message : "Sign up failed";
      setErr(msg);
    } finally {
      setSubmitting(false);
    }
  ...
  async function onGoogle() {
    ...
    try {
      ...
      const msg = e2 instanceof Error ? e2.message : "Google signup failed";
      setErr(msg);
      setGoogleBusy(false);
    }
  }
